...
const IconFlower = ({ className }: { className: string }) => {
  return (
    <svg id="Layer_1" version="1.1" viewBox="0 0 64 64" className={className}>
      <path
      ...
      <path
        ...
        fill="none"
      />
      <line fill="none" x1="39" x2="25" y1="47" y2="47" />
      <line fill="none" x1="32.3" x2="32.3" y1="32.2" y2="39.3" />
      <path d="  M27.9,31.5c0,0,2.2,0.8,4.4,0.8s4.4-0.6,4.4-0.6" fill="none" />
      <path
